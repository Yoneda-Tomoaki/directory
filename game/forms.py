...
class MemberForm(forms.ModelForm):
    ...
    progress_choices = [('','選択してください')] + list(Members.progress_states)
    sex = [('','選択してください')] + list(Members.sex)
    
    
    class Meta:
        model = Members
        fields = ['name', "gender",'input_day', 'enter_day', 'exit_day', 'training', 'participation_cost_submit_or_not']
